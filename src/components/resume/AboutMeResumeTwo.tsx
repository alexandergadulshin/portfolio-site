...
const experienceData: ExperienceItem[] = [
    {
        id: 1,
        year: "2015 - 2018",
        title: "Expert in Web & Mobile Design",
    ...
    },
    {
        id: 2,
        year: "2019 - 2021",
        title: "Proficient with Adobe & Figma",
    ...
    },
    {
        id: 3,
        year: "2022 - 2024",
        title: "Strong Visual Communication",
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-7">
                        <div className="about-me-resume-content mb-20">
                            <h2 className="about-me-resume-maintitle text-uppercase reveal-text">
                                Experience <br /> Digital Evolution
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-3">
                        <div className="about-me-subtitle-wrap d-flex justify-content-lg-end align-items-lg-end h-100">
...
export default AboutMeResumeTwo;
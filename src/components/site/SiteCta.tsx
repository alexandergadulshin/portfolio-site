                    ...
                    <div className="row align-content-end">
                        <div className="col-lg-7">
                            <div className="ca-cta-title-wrap p-relative mb-40">
                                ...
                                <p className="text-white mb-40">Talk to me about your business and I&apos;ll talk to you about what I&apos;d build first. The call is free and then you&apos;ll decide what happens next.</p>

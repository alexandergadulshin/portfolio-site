                    ...
                    <div className="row align-content-end">
                        <div className="col-lg-7">
                            <div className="ca-cta-title-wrap p-relative mb-40">
                                ...
                                <p className="text-white mb-40">Talk to me about your business and I&apos;ll tell you what I&apos;d build first and the call is free and after that you decide what happens next.</p>

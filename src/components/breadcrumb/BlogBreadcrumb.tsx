...
const BlogBreadcrumb = () => {
    return (
        <div className="tp-breadcrumb-area tp-pd-2-ptb pt-175 pb-50">
            <div className="container">
                <div className="row">
                    <div className="col-xl-8 offset-xl-3">
                        <div className="tp-breadcrumb-main p-relative mb-30">
                            <h2 className="tp-breadcrumb-title tp-ff-sequel-bold-head text-uppercase fs-152 mb-20 tp_fade_anim" data-delay=".3">Our Blog</h2>
                            <div className="tp-breadcrumb-dec-wrap d-flex ml-100 tp_fade_anim" data-delay=".4">

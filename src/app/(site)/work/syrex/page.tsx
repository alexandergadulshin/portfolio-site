    ...
    return (
        <main>
            ...
            <CaseSection title="What I built">
                <p>A tool that turns a product page and a short brief into a batch of short video ads and it writes the script and voices it and puts on screen text over the product images and stock clips then exports a bunch of variations.</p>
                <p>I wrote the pipeline myself and a language model writes each script and a voice model reads it then a video tool puts the cut together and the media buyers test and pick the winners in a web dashboard I built for them.</p>
            ...
            <CaseSection title="My role">
                ...
                <p>The choice that mattered most was making 10 versions per product instead of one finished cut and the media buyers found winners in each batch that no single cut would of shown.</p>
            </CaseSection>
            <CaseSection title="What this means for your business">
                <p>The same thing works smaller too and one tool put in the right spot in your process pays for itself the moment it removes the bottleneck and if your bottleneck is content or follow up I can find the spot.</p>

    ...
    return (
        <main>
            ...
            <CaseSection title="The problem">
                ...
                <p>One ad took a creator, plus 2 days of scripting and editing. Media buyers wanted 10 variations to test rather than one polished cut.</p>
            </CaseSection>
            <CaseSection title="What I built">
                ...
                <p>I wrote the pipeline myself. A language model drafts each script and a voice model reads it. A video tool then assembles the cut, and media buyers pick winners inside a web dashboard I built for them.</p>
            ...
            <CaseSection title="My role">
                ...
                <p>The choice that mattered most was to generate 10 variations per product instead of one finished ad. Media buyers found winners in each batch that no single cut would have shown.</p>
            </CaseSection>

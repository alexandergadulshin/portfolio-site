...
export default function Work() {
    return (
        <main>
            <PageIntro label="Selected work" title={<>Results first,<br />process second</>} lede="Each build starts with the evidence and moves on to the work behind the results." />

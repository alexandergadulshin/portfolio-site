...
export default function Work() {
    return (
        <main>
            <PageIntro label="Selected work" title={<>Results first,<br />process second</>} lede="Each build opens with the evidence then gets into the work behind the results." />

    ...
    return (
        <main>
            ...
            <CaseSection title="The result">
                <p>{`Clients pay to use this bot to make there product videos, each client connects their own accounts and runs the bot on their own credits and gets the output without me in between and the busy owners keep coming back to it.`}</p>
            </CaseSection>
            <CaseSection title="The problem">
                <p>{`Product videos are the fuel of social selling and sellers burn through them, making one by hand means a shoot and an edit and that's hours per cut and the stream dries up the second the owner gets busy which is most weeks.`}</p>
            </CaseSection>
            <CaseSection title="What I built">
                <p>{`A bot that lives where the client already works which is their chat, the client drops in a product link and the bot reads the product page and builds a scene around the product photos then animates it into a 5 second vertical video and sends the file back in the same chat.`}</p>
                ...
                <ExampleStrip images={videoBotStills} caption="The output, stills from videos the bot made" />
            </CaseSection>
            <CaseSection title="What this means for your business">
                <p>{`This bot is the same idea as my tool installs only grown into a full product, it takes one task off the plate which is making product videos and hands the keys to whoever owns that task and if your business has a bottleneck like this one call is enough to figure out where the tool goes.`}</p>

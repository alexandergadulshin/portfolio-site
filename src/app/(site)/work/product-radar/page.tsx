    ...
    return (
        <main>
            ...
            <CaseSection title="What I built">
                <p>{`A tool that scans the creator list on a schedule and filters the products by the signals the client set. The tool writes the results to a spreadsheet and a private dashboard, and sends a daily digest of new finds to the client's chat. The client checks one page with morning coffee and gets on with the day.`}</p>
